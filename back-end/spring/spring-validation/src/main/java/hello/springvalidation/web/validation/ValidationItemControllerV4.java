package hello.springvalidation.web.validation;

import hello.springvalidation.item.Item;
import hello.springvalidation.item.ItemRepository;
import hello.springvalidation.item.SaveCheck;
import hello.springvalidation.item.UpdateCheck;
import hello.springvalidation.web.form.ItemSaveForm;
import hello.springvalidation.web.form.ItemUpdateForm;
...
//    @PostMapping("/add")
    ...
    @PostMapping("/add") // ("item")이건 뺴도 됨 타임리프때문에 해둔 것.
